...
in mediump vec3 v_posWS;
in mediump vec3 v_nDirWS;
in mediump vec3 v_tDirWS;
in mediump vec3 v_bDirWS;
in mediump vec2 v_uv0;
layout(location = 0) out mediump vec4 glResult;
...
void main()
{
    ...
    float ao = 1.0;
    mediump vec3 _2112 = normalize(v_nDirWS);
